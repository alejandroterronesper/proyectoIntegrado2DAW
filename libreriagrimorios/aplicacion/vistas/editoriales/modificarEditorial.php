...
echo CHTML::dibujaEtiqueta("h2", [], "Modificar editorial: " .$datos["nombre"], true).PHP_EOL;
...
echo CHTML::dibujaEtiqueta("div", ["class" => "divCRUDLIBROS"], null, false).PHP_EOL;
    ...
    echo CHTML::iniciarForm("#", "POST", []).PHP_EOL;
            ...
            echo CHTML::campoText("nombre", $datos["nombre"], ["readonly" => true]).PHP_EOL;
            echo "<br>".PHP_EOL;
            ...
            echo CHTML::campoBotonSubmit("Modificar editorial",  ["name" => "inputModEditorial" , "class" => "boton", "style" => "margin-top: 1%"]).PHP_EOL;
...
echo CHTML::dibujaEtiquetaCierre("div").PHP_EOL;
    ...
    echo CHTML::dibujaEtiqueta("div", ["class" => "operaciones"], null, false).PHP_EOL;
        ...
        echo CHTML::dibujaEtiqueta("fieldset", [], null, false).PHP_EOL;
            ...
            echo CHTML::botonHtml(CHTML::link("Ver editorial", ["editoriales", "verEditorial/id=".$datos["cod_editorial"]]), ["class"=>"boton"]).PHP_EOL;


            if ($datos["cese"] === 0){
                echo CHTML::botonHtml(CHTML::link("Borrar editorial", ["editoriales", "borrarEditorial/id=".$datos["cod_editorial"]]), ["class"=>"boton"]).PHP_EOL;
            }
