...
echo CHTML::dibujaEtiqueta("h2", [], "Añade libro: " .$titulo, true).PHP_EOL;
...
echo CHTML::dibujaEtiqueta("div", ["class" => "divCRUDLIBROS"], null, false).PHP_EOL;
    ...
    echo CHTML::dibujaEtiqueta("div", ["class" => "divCRUDInfo"], null, false).PHP_EOL;
        ...
        echo CHTML::iniciarForm("", "POST", [ "enctype" =>"multipart/form-data"]).PHP_EOL;
                ...
                echo CHTML::modeloText($libro, "titulo", ["size" => 40]).PHP_EOL;
                ...
                echo CHTML::modeloText($libro, "fecha_lanzamiento", ["size" => 40, "placeholder" => "dd/mm/aaaa"]).PHP_EOL;
                ...
                echo "<br>".PHP_EOL;
                echo "<br>".PHP_EOL;
                echo CHTML::campoBotonSubmit("Registrar", ["class" => "boton", "name" => "anadirLibroInput"]).PHP_EOL;
