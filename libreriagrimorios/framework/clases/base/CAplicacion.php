<?php
	...
	class CAplicacion
	{
		private String $_controlDefecto="inicial";
		private CBaseDatos $_BD;
		private bool $_URL_AMIGABLES=false;
		private array $_prop=array();
		private CSesion $_sesion; //instancia de CSesion
		private CAcceso $_Acceso; //instancia de CAcceso
		private CACLBD $_ACL; //instancia de CACLBD
